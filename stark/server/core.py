...
class Route():
        ...
        for name, param in parameters.items():
            if name in path_names:
                ...
                if method in ('GET', 'DELETE'):
                    for field_name, validator in param.annotation.validator.properties.items():
                        field = Field(name=field_name, location='query', schema=validator)
                        fields.append(field)
                else:
    ...
    @staticmethod
    def coerce_generics(annotation):
